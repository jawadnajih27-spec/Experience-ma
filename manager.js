...
<header class="sticky top-0 z-50 border-b border-white/60 glass">
 ...
 codex/build-professional-version-2.0-3ygztp
...
<section class="max-w-7xl mx-auto px-4 md:px-6 pt-8 md:pt-10">
 ...
 codex/build-professional-version-2.0-3ygztp
        ...
        <span class="hero-chip inline-flex px-4 py-1.5 rounded-full text-xs font-bold tracking-wide">v2.0 Premium Experience</span>
 main
 ...
 codex/build-professional-version-2.0-3ygztp
        ...
        <div class="flex flex-wrap items-center gap-3 pt-2">
          ...
          تصميم أنيق، تجربة سريعة، وسلة ذكية تحفظ اختيارات عملائك لحظة بلحظة.
          تم بناء هذه الواجهة لتنافس أحدث المتاجر العالمية بدون تعقيد.
        </p>
        <div class="flex flex-wrap items-center gap-3 pt-2">
          <span class="stat-badge rounded-xl px-3 py-2 text-xs font-bold text-slate-700">⚡ شحن مرئي سريع</span>
          <span class="stat-badge rounded-xl px-3 py-2 text-xs font-bold text-slate-700">🔒 تجربة آمنة</span>
          <span class="stat-badge rounded-xl px-3 py-2 text-xs font-bold text-slate-700">🌍 جاهز للتوسع العالمي</span>
 main
        </div>
...
<aside id="cart-sidebar" class="cart-sidebar flex flex-col">
 ...
 codex/build-professional-version-2.0-3ygztp
    ...
    <h2 class="font-black text-lg text-slate-900">سلة التسوق الفاخرة 🛒</h2>
 main
...
function renderProducts(list) {
 ...
 codex/build-professional-version-2.0-3ygztp
        ...
        onerror="this.src='https://placehold.co/600x600/f1f5f9/94a3b8?text=📦'">
 main
      <div class="p-2 pt-4">
...
function openModal(id) {
 ...
 codex/build-professional-version-2.0-3ygztp
  ...
  document.getElementById('modal-img').onerror = function() { this.src = 'https://placehold.co/800x600/f1f5f9/94a3b8?text=📦'; };
 main
